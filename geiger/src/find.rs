...
";
    ...
    #[rstest(
        ...
        case(
            ...
            (String::from("snappy_compress"), ExternDefinition { file: file_path.clone(),  line: 6, column: 7, name:  String::from("snappy_compress")}),
            (String::from("snappy_uncompress"), ExternDefinition { file: file_path.clone(), line: 10, column: 7, name: String::from("snappy_uncompress")  }),
            (String::from("snappy_max_compressed_length"), ExternDefinition { file: file_path.clone(), line: 14, column: 7, name: String::from("snappy_max_compressed_length")  }),
            (String::from("snappy_uncompressed_length"), ExternDefinition { file: file_path.clone(), line: 15, column: 7, name: String::from("snappy_uncompressed_length")  }),
            (String::from("snappy_validate_compressed_buffer"), ExternDefinition { file: file_path.clone(),  line: 18, column: 7, name: String::from("snappy_validate_compressed_buffer") }),
            (String::from("foo"), ExternDefinition { file: file_path.clone(), line: 54, column: 11, name: String::from("foo")  }),
        ])),
        case(
            &PathBuf::from("/test/extern_file_content_string"),
            ...
            (String::from("snappy_uncompressed_length"), ExternDefinition { file: file_path.clone(),  line: 15, column: 7, name: String::from("snappy_uncompressed_length")  }),
            (String::from("snappy_validate_compressed_buffer"), ExternDefinition { file: file_path.clone(),  line: 18, column: 7, name: String::from("snappy_validate_compressed_buffer") }),
            (String::from("hello_from_rust"), ExternDefinition { file: file_path.clone(),  line: 23, column: 18, name: String::from("hello_from_rust")  }),
            (String::from("foo"), ExternDefinition { file: file_path.clone(),  line: 54, column: 11, name: String::from("foo")  }),
            (String::from("bar"), ExternDefinition { file: file_path.clone(),  line: 59, column: 22, name: String::from("bar")  }),
        ]))
    )]
